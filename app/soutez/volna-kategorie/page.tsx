            ...
            <div className="relative min-h-screen text-white flex items-center justify-center p-6">
                ...
                <div className="max-w-xl w-full">
                    <motion.div
                        ...
                        className="p-12 text-center space-y-8 bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] shadow-2xl"
                    >
                        ...
                        <div className="space-y-3">
                            <h1 className="text-3xl font-black uppercase tracking-tighter italic">LIMIT VYČERPÁN.</h1>
                        ...
                        <motion.button
                            ...
                            className="bg-white text-black px-10 py-5 rounded-2xl font-black uppercase tracking-widest italic text-xs hover:bg-slate-200 transition-colors"
                        >
                            Zpět do soutěže
                        </motion.button>
                    </motion.div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic">
                                Volná <span className="text-white/30">Kategorie.</span>
                            </h1>
                            <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">Bod za jakékoliv místo, jednou týdně</p>
                        </div>
                    </div>
                </div>
                ...
                {success ? (
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <h2 className="text-3xl font-black uppercase tracking-tighter italic">ODESLÁNO.</h2>
                            <p className="text-white/40 text-[10px] font-bold uppercase tracking-widest leading-loose">Váš záznam byl odeslán ke schválení.<br />Přesměrovávám vás zpět...</p>
                        </div>
                    </motion.div>
                ) : (
                    <div className="space-y-8">
                        <div className="p-6 bg-white/5 border border-white/10 rounded-3xl space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-white/60">INFORMACE</span>
                            </div>
