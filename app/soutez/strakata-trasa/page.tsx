                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white">
                                Strakatá <span className="text-slate-300 dark:text-white/30">Trasa.</span>
                            </h1>
                            <p className="text-slate-400 dark:text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">20 výzev pro legendární sběratele</p>
                        </div>
                    </div>
                </div>
                ...
                {success ? (
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <h2 className="text-3xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white">ZAZNAMENÁNO.</h2>
                            <p className="text-slate-500 dark:text-white/40 text-[10px] font-bold uppercase tracking-widest leading-loose">Váš úspěch byl zapsán do strakaté historie.<br />Přesměrovávám vás zpět...</p>
                        </div>
                    </motion.div>
                ) : (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/80 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-500 dark:text-white/40 mb-2">
                                    ...
                                    return (
                                        <motion.button
                                            ...
                                            className={cn(
                                                ...
                                                isSelected
                                                    ? "bg-slate-900 dark:bg-white/10 border-slate-900 dark:border-white/30 shadow-2xl"
                                                    : "bg-white/50 dark:bg-white/5 border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10"
                                            )}
                                        >
                                            <div className="flex items-center gap-4 relative z-10">
                                                <div className={cn(
                                                    "w-10 h-10 rounded-xl flex items-center justify-center transition-colors",
                                                    isSelected ? "bg-white text-slate-900" : "bg-white/50 dark:bg-white/5 group-hover:bg-white/80 dark:group-hover:bg-white/10"
                                                )}>
                                                    <Sparkles className={cn("w-5 h-5", isSelected ? "text-slate-900" : "text-slate-400 dark:text-white/30")} />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <p className={cn("text-sm font-bold uppercase tracking-tight", isSelected ? "text-white" : "text-slate-900 dark:text-white/50")}>{cat.name}</p>
                                                    <p className={cn("text-[9px] font-bold uppercase tracking-widest mt-0.5", isSelected ? "text-white/50" : "text-slate-400 dark:text-white/20")}>Měsíční výzva</p>
                                                </div>
                                            </div>
                        ...
                        <div className="lg:col-span-8">
                            <AnimatePresence mode="wait">
                                {selectedCategory ? (
                                    ...
                                    >
                                        <div className="p-6 bg-white/80 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl space-y-4 shadow-sm">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-white/60">PRAVIDLA KATEGORIE</span>
                                            </div>
                                            <div className="grid sm:grid-cols-3 gap-4">
                                                {[
                                                    ...
                                                    <div key={i} className="space-y-1">
                                                        <p className="text-[9px] font-bold text-slate-400 dark:text-white/20 uppercase tracking-widest">{stat.label}</p>
                                        ...
                                        <div className="bg-white/80 dark:bg-white/5 backdrop-blur-3xl border border-slate-200 dark:border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl space-y-10">
                                            <div className="space-y-8">
                                                ...
                                                <div className="space-y-3">
                                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-white/40 ml-1">
                                                        Detaily
                                                    </label>
                                                    <IOSTextarea
                                                ...
                                                <div className="space-y-4">
                                                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-white/40 ml-1 flex items-center gap-2">
                                    ...
                                    <div className="h-[400px] flex flex-col items-center justify-center text-slate-300 dark:text-white/10 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-[2.5rem] bg-white/50 dark:bg-white/2 space-y-4">
                                        <Trophy className="w-16 h-16 opacity-10" />
                                        <div className="text-center space-y-1">
                                            <p className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 dark:text-white/20">VYBERTE VÝZVU</p>
                                            <p className="text-[9px] font-bold uppercase tracking-widest text-slate-300 dark:text-white/10 italic">POKRAČUJTE VOLBOU KATEGORIE VLEVO</p>
                                        </div>
                                    </div>
                                )}
                            </AnimatePresence>
